...
$( document ).on( "pagebeforeshow", "#postIndex", function() {
	...
	var url = "http://www.themalaysiantimes.com.my/api/get_recent_posts/";
...
$( document ).on( "pagebeforeshow", "#postPage", function() {
    ...
    var postid = getQueryVariable("id");
    var url = "http://www.themalaysiantimes.com.my/api/get_post/?post_id="+postid+"&callback=?";
...
function post(json) {
    ...
    html += "<img  src='" +json.post.thumbnail +"'>";
